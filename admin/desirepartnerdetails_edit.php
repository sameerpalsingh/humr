...
$sql = mysqli_query($link, "select * from hum_caste");
	while($caste = mysqli_fetch_assoc($sql)) {
...
<body>	
<form name="desirepartnerdetails" method="post" action="desirepartnerdetails_update.php?id=<?php echo $id; ?>" onsubmit=" return login_validate4();">
<table>
<tr>
<td>
<table>
<tr><td>
<font class="category"> 
<h3 style="color:#669933"> Desired-Partner-Details</font></h3>
                        ...
                        <tbody>
                         ...
                         <tr>
							...
							<div style="width:200px;float:left;">
									...
									<div id="disp_1" style= '<?php if(preg_match('/Never Married/',$p_status)) { echo '';} else {echo 'display:none'; } ?>' >
									...
									<div id="disp_2" style='<?php if(preg_match('/Awaiting Divorce/',$p_status)) { echo '';} else {echo 'display:none'; } ?>'>
									...
									<div id="disp_3" style='<?php if(preg_match('/Divorced/',$p_status)) { echo '';} else {echo 'display:none'; } ?>'>
                            		...
                            		<div id="disp_4" style='<?php if(preg_match('/Other/',$p_status)) { echo '';} else {echo 'display:none'; } ?>' >
									<input id="disp_ms_4" type="checkbox" value="Other" name="mrtstatus[]" <?php if(preg_match('/Other/',$p_status)) echo 'checked'; ?> />Other</div>
									

									<div id="disp_5" style='<?php if(preg_match('/Widowed/',$p_status)) { echo '';} else {echo 'display:none'; } ?>' >
									...
									<div id="disp_6" style='<?php if(preg_match('/Annulled/',$p_status)) { echo '';} else {echo 'display:none'; } ?>' >
                         ...
                         <tr>
							...
							<div style="width:200px;float:left;">
									...
									<div style="overflow-x:hidden;overflow-y:scroll;height:150px;width:200px;vertical-align:bottom;border:1px solid #CCCCCC;">
									<div id="dispmt_1" style='<?php if(preg_match('|All India|',$p_region)) {echo '';} else {echo 'display:none'; }?>' ><input id="dispmt_mt_1" type="checkbox" value="All India" name="region[]" <?php if(preg_match('|All India|',$p_region)) echo 'checked'; ?> />All India</div>

									<div id="dispmt" style="font-size: 8pt; color:#CC0033;">North</div>
									<div id="dispmt_2" style='<?php if(preg_match('|Haryana|',$p_region)) {echo '';} else {echo 'display:none'; }?>' > <input id="dispmt_mt_2" type="checkbox" value="Haryana" name="region[]"  <?php if(preg_match('|Haryana|',$p_region)) echo 'checked'; ?>/>Haryana</div>

									<div id="dispmt_3" style='<?php if(preg_match('|Himanchal Pradesh|',$p_region)) {echo '';} else {echo 'display:none'; }?>' ><input id="dispmt_mt_3" type="checkbox" value="Himanchal Pradesh" name="region[]" <?php if(preg_match('|Himanchal Pradesh|',$p_region)) echo 'checked';?>/>Himanchal Pradesh</div>

									<div id="dispmt_4" style='<?php if(preg_match('|Jammu & Kashmir|',$p_region)) {echo '';} else {echo 'display:none'; }?>' ><input id="dispmt_mt_4" type="checkbox" value="Jammu & Kashmir" name="region[]" <?php if(preg_match('|Jammu & Kashmir|',$p_region)) echo 'checked';?>/>Jammu & Kashmir</div>

									<div id="dispmt_5" style='<?php if(preg_match('|Punjab|',$p_region)) {echo '';} else {echo 'display:none'; }?>' ><input id="dispmt_mt_5" type="checkbox" value="Punjab" name="region[]" <?php if(preg_match('|Punjab|',$p_region)) echo 'checked';?> />Punjab</div>

									<div id="dispmt_6" style='<?php if(preg_match('|Uttaranchal|',$p_region)) {echo '';} else {echo 'display:none'; }?>' ><input id="dispmt_mt_6" type="checkbox" value="Uttaranchal" name="region[]"  <?php if(preg_match('|Uttaranchal|',$p_region)) echo 'checked';?>/>Uttaranchal</div>

									<div id="dispmt_7" style='<?php if(preg_match('|Uttar Pradesh|',$p_region)) {echo '';} else {echo 'display:none'; }?>' ><input id="dispmt_mt_7" type="checkbox" value="Uttar Pradesh" name="region[]" <?php if(preg_match('|Uttar Pradesh|',$p_region)) echo 'checked'; ?>/>Uttar Pradesh</div>

									
									<div id="dispmt" style="font-size: 8pt; color:#CC0033;">West</div>
									<div id="dispmt_13" style='<?php if(preg_match('|Andhra Pradesh|',$p_region)) {echo '';} else {echo 'display:none'; }?>' ><input id="dispmt_mt_13" type="checkbox" value="Andhra Pradesh" name="region[]" <?php if(preg_match('|Andhra Pradesh|',$p_region)) {echo 'checked';} ?>/>Andhra Pradesh</div>

									<div id="dispmt_14" style='<?php if(preg_match('|Chhatishgarh|',$p_region)) {echo '';} else {echo 'display:none'; }?>'><input id="dispmt_mt_14" type="checkbox" value="Chhatishgarh" name="region[]" <?php if(preg_match('|Chhatishgarh|',$p_region)) {echo 'checked';}?> />Chhatishgarh</div>

									<div id="dispmt_15" style='<?php if(preg_match('|Goa|',$p_region)) {echo '';} else {echo 'display:none'; }?>'><input id="dispmt_mt_15" type="checkbox" value="Goa" name="region[]" <?php if(preg_match('|Goa|',$p_region)) {echo 'checked';}?>/>Goa</div>

									<div id="dispmt_16" style='<?php if(preg_match('|Gujarat|',$p_region)) {echo '';} else {echo 'display:none'; }?>' ><input id="dispmt_mt_16" type="checkbox" value="Gujarat" name="region[]" <?php if(preg_match('|Gujarat|',$p_region)) {echo 'chcked';}?>/>Gujarat</div>

																		
									<div id="dispmt_18" style='<?php if(preg_match('|Rajasthan|',$p_region)) {echo '';} else {echo 'display:none'; }?>' ><input id="dispmt_mt_18" type="checkbox" value="Rajasthan" name="region[]" <?php if(preg_match('|Rajasthan|',$p_region)) {echo 'checked';}?> />Rajasthan</div>

									<div id="dispmt_18" style='<?php if(preg_match('|Madhya Pradesh|',$p_region)) {echo '';} else {echo 'display:none'; }?>' ><input id="dispmt_mt_18" type="checkbox" value="Madhya Pradesh" name="region[]" <?php if(preg_match('|Madhya Pradesh|',$p_region)) {echo 'checked';}?> />Madhya Pradesh</div>

									<div id="dispmt_18" style='<?php if(preg_match('|Maharashtra|',$p_region)) {echo '';} else {echo 'display:none'; }?>' ><input id="dispmt_mt_18" type="checkbox" value="Maharashtra" name="region[]" <?php if(preg_match('|Maharashtra|',$p_region)) {echo 'checked';}?> />Maharashtra</div>

									<div id="dispmt_18" style='<?php if(preg_match('|Daman &amp; Diu|',$p_region)) {echo '';} else {echo 'display:none'; }?>' ><input id="dispmt_mt_18" type="checkbox" value="Daman &amp; Diu" name="region[]" <?php if(preg_match('|Daman &amp; Diu|',$p_region)) {echo 'checked';}?> />Daman &amp; Diu</div>

									<div id="dispmt-South" style="font-size: 8pt; color:#CC0033;">South</div>
									<div id="dispmt_19" style='<?php if(preg_match('|Orissa|',$p_region)) {echo '';} else {echo 'display:none'; }?>'><input id="dispmt_mt_19" type="checkbox" value="Orissa" name="region[]" <?php if(preg_match('|Orissa|',$p_region)) {echo 'checked';}?>/>Orissa</div>

									<div id="dispmt_20" style='<?php if(preg_match('|Karnataka|',$p_region)) {echo '';} else {echo 'display:none'; }?>'><input id="dispmt_mt_20" type="checkbox" value="Karnataka" name="region[]" <?php if(preg_match('|Karnataka|',$p_region)) {echo 'checked';}?>/>Karnataka</div>

									<div id="dispmt_21" style='<?php if(preg_match('|Kerala|',$p_region)) {echo '';} else {echo 'display:none'; }?>'><input id="dispmt_mt_21" type="checkbox" value="Kerala" name="region[]" <?php if(preg_match('|Kerala|',$p_region)) {echo 'checked';}?>/>Kerala</div>
									
									<div id="dispmt_22" style='<?php if(preg_match('|Tamil Nadu|',$p_region)) {echo '';} else {echo 'display:none'; }?>'><input id="dispmt_mt_22" type="checkbox" value="Tamil Nadu" name="region[]" <?php if(preg_match('|Tamil Nadu|',$p_region)) echo 'checked';?>/>Tamil Nadu</div>
									
									<div id="dispmt_23" style='<?php if(preg_match('|Lakshadweep/Mahl|',$p_region)) {echo '';} else {echo 'display:none'; }?>' ><input id="dispmt_mt_23" type="checkbox" value="Lakshadweep/Mahl" name="region[]" <?php if(preg_match('|Lakshadweep/Mahl|',$p_region)) {echo 'checked';}?>/>Lakshadweep/Mahl</div>
									
									<div id="dispmt-East" style="font-size: 8pt; color:#CC0033;">East</div>
									
									<div id="dispmt_24" style='<?php if(preg_match('|Assam|',$p_region)) {echo '';} else {echo 'display:none'; }?>'><input id="dispmt_mt_24" type="checkbox" value="Assam" name="region[]" <?php if(preg_match('|Assam|',$p_region)) {echo 'checked';}?>/>Assam</div>
									
									<div id="dispmt_25" style='<?php if(preg_match('|Arunanchl Pradesh|',$p_region)) {echo '';} else {echo 'display:none'; }?>' ><input id="dispmt_mt_25" type="checkbox" value="Arunanchl Pradesh" name="region[]" <?php if(preg_match('|Arunanchl Pradesh|',$p_region)) {echo 'checked';}?>/>Arunanchl Pradesh</div>
									
									<div id="dispmt_26" style='<?php if(preg_match('|Bihar|',$p_region)) {echo '';} else {echo 'display:none'; }?>'><input id="dispmt_mt_26" type="checkbox" value="Bihar" name="region[]" <?php if(preg_match('|Bihar|',$p_region)) {echo 'checked';}?>/>Bihar</div>
									
									<div id="dispmt_27" style='<?php if(preg_match('|Jharkhand|',$p_region)) {echo '';} else {echo 'display:none'; }?>'><input id="dispmt_mt_27" type="checkbox" value="Jharkhand" name="region[]"  <?php if(preg_match('|Jharkhand|',$p_region)) {echo 'checked';}?>/>Jharkhand</div>
									
									<div id="dispmt_28" style='<?php if(preg_match('|Sikkim|',$p_region)) {echo '';} else {echo 'display:none'; }?>' ><input id="dispmt_mt_28" type="checkbox" value="Sikkim" name="region[]"  <?php if(preg_match('|Sikkim|',$p_region)) {echo 'checked';}?>/>Sikkim</div>
									
									<div id="dispmt_29" style='<?php if(preg_match('|Manipur|',$p_region)) {echo '';} else {echo 'display:none'; }?>'><input id="dispmt_mt_29" type="checkbox" value="Manipur" name="region[]" <?php if(preg_match('|Manipur|',$p_region)) {echo 'checked';}?>/>Manipur</div>
									
									<div id="dispmt_30" style='<?php if(preg_match('|Mizoram|',$p_region)) {echo '';} else {echo 'display:none'; }?>' ><input id="dispmt_mt_30" type="checkbox" value="Mizoram" name="region[]"  <?php if(preg_match('|Mizoram|',$p_region)) {echo 'checked';}?>/>Mizoram</div>
									
									<div id="dispmt_31" style='<?php if(preg_match('|Meghalaya|',$p_region)) {echo '';} else {echo 'display:none'; }?>'><input id="dispmt_mt_31" type="checkbox" value="Meghalaya" name="region[]" <?php if(preg_match('|Meghalaya|',$p_region)) {echo 'checked';}?>/>Meghalaya</div>
									
									<div id="dispmt_32" style='<?php if(preg_match('|Nagaland|',$p_region)) {echo '';} else {echo 'display:none'; }?>'><input id="dispmt_mt_32" type="checkbox" value="Nagaland" name="region[]" <?php if(preg_match('|Nagaland|',$p_region)) {echo 'checked';}?>/>Nagaland</div>
									
									<div id="dispmt_33" style='<?php if(preg_match('|Tripura|',$p_region)) {echo '';} else {echo 'display:none';}?>' ><input id="dispmt_mt_33" type="checkbox" value="Tripura" name="region[]" <?php if(preg_match('|Tripura|',$p_region)) {echo 'checked';}?>/>Tripura</div>
									
									<div id="dispmt_34" style='<?php if(preg_match('|Foreign origin|',$p_region)) {echo '';} else {echo 'display:none';}?>' ><input id="dispmt_mt_34" type="checkbox" value="Foreign origin" name="region[]" <?php if(preg_match('|Foreign origin|',$p_region)) {echo 'checked';}?> />Foreign origin</div>
									</div>
						   ...
						   <tr>
							...
							<td colspan="4" height="6">
								...
								<div style="width:200px;float:left;">
									...
									<input id="checkcst_cheese_<?php echo $c; ?>" type="checkbox" value="<?php echo $caste_name[$c]; ?>" name="Buddhist" <?php		
									if (preg_match('|'.$caste_name[$c].'|',$p_cast)) echo 'checked';?> /><?php echo $caste_name[$c]; ?> </div>
									<?php
									}
									?>
									</div>
							...
							<div style="width:200px;float:left;">
									...
									for($c = 1;$c < $total_caste;$c++) {
									?>
									<div id="dispcst_<?php echo $c; ?>" style='<?php if (preg_match('|'.$caste_name[$c].'|',$p_cast)){ echo ''; } else {echo 'display:none'; }?>'>
                           ...
                           &nbsp;
							...
							<div style="width:200px;height:150px;float:left;">
									...
									<div style="overflow-x:hidden;overflow-y:scroll;height:150px;width:200px;vertical-align:bottom;border:1px solid #CCCCCC;">
									<!--<span style="color: rgb(10, 137, 254);margin:15px;">------------</span>-->
									<div id="dispan_1" style='<?php if(preg_match('|No Income|',$p_income)) {echo '';} else {echo 'display:none';}?>'><input id="dispan_an_1" type="checkbox" value="No" name="" <?php if(preg_match('/No Income/',$p_income)) echo 'checked'; ?>/>No Income</div>
									
									<div id="dispan_2" style='<?php if(preg_match('|Under Rs.50,000|',$p_income)) {echo '';} else {echo 'display:none';}?>'><input id="dispan_an_2" type="checkbox" value="Under Rs.50,000" name="income[]" <?php if(preg_match('|Under Rs.50,000|',$p_income)) echo 'checked'; ?>/>Under Rs.50,000</div>

									<div id="dispan_3" style='<?php if(preg_match('|Rs.50,001 - 1,00,000|',$p_income)) {echo '';} else {echo 'display:none';}?>'><input id="dispan_an_3" type="checkbox" value="Rs.50,001 - 1,00,000" name="income[]" <?php if(preg_match('|Rs.50,001 - 1,00,000|',$p_income)) echo 'checked'; ?>/>Rs.50,001 - 1,00,000</div>

									<div id="dispan_4" style='<?php if(preg_match('|Rs.1,00,001 - 2,00,000|',$p_income)) {echo '';} else {echo 'display:none';}?>'><input id="dispan_an_4" type="checkbox" value="Rs.1,00,001 - 2,00,000" name="income[]"  <?php if(preg_match('|Rs.1,00,001 - 2,00,000|',$p_income)) echo 'checked'; ?> />Rs.1,00,001 - 2,00,000</div>

									<div id="dispan_5" style='<?php if(preg_match('|Rs.2,00,001 - 3,00,000|',$p_income)) {echo '';} else {echo 'display:none';}?>'><input id="dispan_an_5" type="checkbox" value="Rs.2,00,001 - 3,00,000" name="income[]"  <?php if(preg_match('|Rs.2,00,001 - 3,00,000|',$p_income)) echo 'checked'; ?>/>Rs.2,00,001 - 3,00,000</div>

									<div id="dispan_6" style='<?php if(preg_match('|Rs.3,00,001 - 4,00,000|',$p_income)) {echo '';} else {echo 'display:none';}?>'><input id="dispan_an_6" type="checkbox" value="Rs.3,00,001 - 4,00,000" name="income[]"<?php if(preg_match('|Rs.3,00,001 - 4,00,000|',$p_income)) echo 'checked'; ?> />Rs.3,00,001 - 4,00,000</div>

									<div id="dispan_7" style='<?php if(preg_match('|Rs.4,00,001 - 5,00,000|',$p_income)) {echo '';} else {echo 'display:none';}?>'><input id="dispan_an_7" type="checkbox" value="Rs.4,00,001 - 5,00,000" name="income[]" <?php if(preg_match('|Rs.4,00,001 - 5,00,000|',$p_income)) echo 'checked'; ?>/>Rs.4,00,001 - 5,00,000</div>

									<div id="dispan_8" style='<?php if(preg_match('|Rs.5,00,001 - 7,50,000|',$p_income)) {echo '';} else {echo 'display:none';}?>'><input id="dispan_an_8" type="checkbox" value="Rs.5,00,001 - 7,50,000" name="income[]" <?php if(preg_match('|Rs.5,00,001 - 7,50,000|',$p_income)) echo 'checked'; ?>/>Rs.5,00,001 - 7,50,000</div>

									<div id="dispan_9" style='<?php if(preg_match('|Rs.7,50,001 - 10,00,000|',$p_income)) {echo '';} else {echo 'display:none';}?>'><input id="dispan_an_9" type="checkbox" value="Rs.7,50,001 - 10,00,000" name="income[]" <?php if(preg_match('|Rs.7,50,001 - 10,00,000|',$p_income)) echo 'checked'; ?> />Rs.7,50,001 - 10,00,000</div>

									<div id="dispan_10" style='<?php if(preg_match('|Rs.10,00,001 - 15,00,000|',$p_income)) {echo '';} else {echo 'display:none';}?>'><input id="dispan_an_10" type="checkbox" value="Rs.10,00,001 - 15,00,000" name="income[]" <?php if(preg_match('|Rs.10,00,001 - 15,00,000|',$p_income)) echo 'checked'; ?> />Rs.10,00,001 - 15,00,000</div>

									<div id="dispan_11" style='<?php if(preg_match('|Rs.15,00,001 - 20,00,000|',$p_income)) {echo '';} else {echo 'display:none';}?>'><input id="dispan_an_11" type="checkbox" value="Rs.15,00,001 - 20,00,000" name="income[]" <?php if(preg_match('|Rs.15,00,001 - 20,00,000|',$p_income)) echo 'checked'; ?>/>Rs.15,00,001 - 20,00,000</div>

									<div id="dispan_12" style='<?php if(preg_match('|Rs.20,00,001 - 25,00,000|',$p_income)) {echo '';} else {echo 'display:none';}?>'><input id="dispan_an_12" type="checkbox" value="Rs.20,00,001 - 25,00,000" name="income[]" <?php if(preg_match('|Rs.20,00,001 - 25,00,000|',$p_income)) echo 'checked'; ?>/>Rs.20,00,001 - 25,00,000</div>

									<div id="dispan_13" style='<?php if(preg_match('|Rs.25,00,001 and above|',$p_income)) {echo '';} else {echo 'display:none';}?>'><input id="dispan_an_13" type="checkbox" value="Rs.25,00,001 and above" name="income[]" <?php if(preg_match('|Rs.25,00,001 and above|',$p_income)) echo 'checked'; ?>/>Rs.25,00,001 and above</div>

									<div id="dispan_14" style='<?php if(preg_match('|Under $25,000|',$p_income)) {echo '';} else {echo 'display:none';}?>'><input id="dispan_an_14" type="checkbox" value="Under $25,000" name="income[]" <?php if(preg_match('|Under $25,000|',$p_income)) echo 'checked'; ?>/>Under $25,000</div>

									<div id="dispan_15" style='<?php if(preg_match('|$25,001 - 40,000|',$p_income)) {echo '';} else {echo 'display:none';}?>'><input id="dispan_an_15" type="checkbox" value="$25,001 - 40,000" name="income[]"<?php if(preg_match('|$25,001 - 40,000|',$p_income)) echo 'checked'; ?>/>$25,001 - 40,000</div>

									<div id="dispan_16" style='<?php if(preg_match('|$40,001 - 60,000|',$p_income)) {echo '';} else {echo 'display:none';}?>'><input id="dispan_an_16" type="checkbox" value="$40,001 - 60,000" name="income[]" <?php if(preg_match('|$40,001 - 60,000|',$p_income)) echo 'checked'; ?>/>$40,001 - 60,000</div>

									<div id="dispan_17" style='<?php if(preg_match('|$60,001 - 80,000|',$p_income)) {echo '';} else {echo 'display:none';}?>'><input id="dispan_an_17" type="checkbox" value="$60,001 - 80,000" name="income[]" <?php if(preg_match('|$60,001 - 80,000|',$p_income)) echo 'checked'; ?> />$60,001 - 80,000</div>

									<div id="dispan_18" style='<?php if(preg_match('|$80,001 - 100,000|',$p_income)) {echo '';} 
									else {echo 'display:none';}?>'><input id="dispan_an_18" type="checkbox" value="$80,001 - 100,000" name="income[]" <?php if(preg_match('|$80,001 - 100,000|',$p_income)) echo 'checked'; ?>/>$80,001 - 100,000</div>

									

									<div id="dispan_20" style='<?php if(preg_match('|$150,001 - 200,000|',$p_income)) {echo '';} else {echo 'display:none';}?>'><input id="dispan_an_20" type="checkbox" value="$150,001 - 200,000" name="income[]"<?php if(preg_match('|$150,001 - 200,000|',$p_income)) echo 'checked'; ?>/>$150,001 - 200,000</div>

									<div id="dispan_21" style='<?php if(preg_match('|$200,001 and above|',$p_income)) {echo '';} else {echo 'display:none';}?>'><input id="dispan_an_21" type="checkbox" value="$200,001 and above" name="income[]"<?php if(preg_match('|$200,001 and above|',$p_income)) echo 'checked'; ?>/>$200,001 and above</div>
									</div>
