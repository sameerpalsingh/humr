/*  Reel Slide Show
 *  Author: Mike http://www.2createawebsites.com/
 *  Visit http://www.2createawebsites.com/ for full source code
*/
...
function reelslideshow(options){
	var $=jQuery
	this.setting={displaymode:{type:'none', pause:2000, cycles:2, pauseonmouseover:true}, orientation:'h', persist:true, slideduration:500} //default settings
