...
<form name="socialinfo" method="post" action="socialinfo_update.php?id=<?php echo$id; ?>" onsubmit="return login_validate2();">
...
<td>
  <img src="images/social-back.gif" alt="" height="30"/></td>
   ...
   <tr>
		...
		<td></td>
		<td>
		 <input type="submit" id="submit" value="submit"  width="76" height="22" border="0" />
		&nbsp;
