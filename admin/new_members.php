                              ...
                              <?php if(isset($update_msg) && $update_msg!='') { ?>
                               <span class="AlertBar"><?php echo $update_msg;?> </span> 
                                ...
                                <TR>
									...
									<TD width="5%" align="left" class=ColumnHead>Gender</TD>
									                                    <TD width="15%" align="left" class=ColumnHead>EmailId</TD>
									<TD width="15%" align="left" class=ColumnHead>UserId</TD>
                    ...
                    */
                    ...
                    if(isset($_REQUEST['showpage']) && $_REQUEST['showpage']!= "") {
                        ...
                        $page = 1;
                                ...
                                $sql = mysqli_query($link, "select * from hum_registration where firstlogin='0' order by id desc limit $from,$show_record_no");
                            ...
                            ?>
                                <TR class=TableRow height="30">
                                    ...
                                    <TD align="left" style="padding:10px;"><a href="admin_edit_member.php?id=<?php echo $view_member['id']; ?>"><?php echo ucwords($view_member['name']); ?></a></TD>
