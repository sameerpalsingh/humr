...
$sql = "SELECT contact_id, DATE_FORMAT(contact_date, '%d %b %Y') as contact_date FROM hum_member_contact WHERE contact_by='$sess_user_id' ORDER BY id DESC";
  ...
  <tr>
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <?php include(DIR_FS_TEMPLATES."wl_interest_sent.tpl.php"); ?>
        </td></tr>
    </table></td>
  </tr>
