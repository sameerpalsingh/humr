...
<html>
    ...
    <form name="familydetails" method="post" action="familydetails_update.php" onsubmit="return familydetail();">
        <table>
            <tr>
                <td colspan="2">
                    <font class="category"><h3 style="color:#669933">Family-Details</h3></font>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td colspan="3"><font class="text">
                    <select style="font-size: 9pt; width: 230px; font-family: arial, verdana, sans-serif"
                        ...
                        <option value="0" selected="selected">-Select any One-</option>
                        <?php echo createDropDownForMotherOccup($motheroccupation); ?>
                    </select>
                    </font></td>
            </tr>
            ...
            <tr>
                ...
                <td colspan="2" style="font-size: 13px; font-family: arial, verdana, sans-serif">Tell us about your parents and/or siblings, what they do, their backgrounds etc.<br/>
                    <span style="float:left;" style="font-size: 12pt; width: 200px; font-family: arial, verdana, sans-serif" > 
                        <textarea name="about_yourfamily" id="about_yourself" style="width: 420px; height:100px;"value="<?php echo stripslashes($aboutfamily); ?>" cols="40" rows="5" class="fl" onKeyDown="limitText(this.form.about_yourfamily, this.form.countdown, 500);" 
