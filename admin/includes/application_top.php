...
if ($_SERVER['HTTP_HOST'] == 'localhost') {
    define('DIR_HOST','http://localhost');
    define('DIR_WS_ROOT','/humraahi/');
} else {
    define('DIR_HOST','http://www.humraahi.com');
    define('DIR_WS_ROOT','/');
}
define('DIR_FS_ROOT',$_SERVER['DOCUMENT_ROOT'].'/humraahi/');
...
if ($_SERVER['HTTP_HOST'] == 'localhost') {
	...
	define('MYSQL_HOSTNAME', 'humraahilive.db.5912495.hostedresource.com');
	define('MYSQL_USERNAME', 'humraahilive');
	define('MYSQL_PASSWORD', 'Mona12345');
	define('MYSQL_DATABASE', 'humraahilive');
	define('MYSQL_PERSISTENCE', false);
}
