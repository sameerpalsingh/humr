<table width="100%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <?php
                    if (isset($_GET['deleted'])) {
						...
						$nam1=$nam[0];
						echo ucwords($nam1) .", You can view your sent messages here.";
                    }
                  ?>
                  </b>
                </div></td>
                      ...
                      <form method="post" action="sentbox_message_delete.php" name="frmSearch" onsubmit="return validate();">
                        <table width="85%" border="0" cellspacing="1" cellpadding="0">
                            <tr bgcolor="#ECEAEA">
                              ...
                              <td width="15%" align="center" class=text>Sent To</td>
                      ...
                      if ($num == 0) {
                          echo '<tr><td colspan="6" class="content" align="center">No messages in your sent box.</td></tr>';
                      }
                      ...
                      ?>
                          ...
                          <td width="5%" align="center" class=text><?php echo $i;?></td>
							...
							<?php  $contact_id=$row['loginid'];
								$rs1 = $db->executeQuery("select name from hum_registration where id='".$contact_id."'");
                      ...
                      if ($num != 0) { ?>
                        <tr bordercolor="#ECEAEA">
                          <td align="left" colspan="5">&nbsp;<input type="submit" name="submit" value="Delete"><input type="hidden" name="txtcheck" value="">
