 <table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                ...
                <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    ...
                    <td><h3 class="page_heading">Expression of Interest Sent</h3></td>
  ...
  $num = $db->numRows($rs);
  if ($num == 0) {
     echo "<tr><td align='center' class='heading' colspan=8>You have not expressed interest in any profile yet.</td></tr>";
  }
  $cnt = 1;
  ...
  <tr bgcolor="<?php echo ($cnt%2==0)?'#f1f1f1':'#eceaea'?>">
      ...
      <td align="center"><img src="<?php echo DIR_WS_USER_IMAGES.getImageFromId($db, $row_member['pic']);?>" class='thumbnail'>
      </td>
